    ...
    <div class="useColumns">
      ...
      <div class="box">
        ...
        <p>
          ...
          pflegen. Hierfür biete ich Ihnen ebenfalls einen Reflexionsraum.
        </p>
      </div>
    </div>
  </MainSection>
    ...
    <div class="useColumns">
      ...
      <div class="box">
        ...
        <List>
          ...
          <li>In Ihren / von Ihnen organisierten Räumlichkeiten</li>

          <li>Supervision ab 2. Termin online möglich</li>
        </List>
      </div>
    </div>
  </MainSection>
